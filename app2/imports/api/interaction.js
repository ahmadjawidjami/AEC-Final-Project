import projectContract from '../../public/build/contracts/Project.json';
import tokenContract from '../../public/build/contracts/ShareToken.json';

// Export the function
export default  interaction = (web3) => {
    ...
    let getProjectContract = (data) => {
        return web3.eth.contract(projectContract.abi).at(data.project);
    }

    // TODO: get token from contract 
    let getTokenContract = (data) => {
        return web3.eth.contract(tokenContract.abi).at(data.token);
    }
